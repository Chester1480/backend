...
// const { cut } = require('../../service/share/nlp/nodejieba');
// const { getTrending, search } = require('../../service/share/imageservice/giphy');
// const redis = require('../../service/share/redis');
// const command = require('../../model/mongocollection/command');

// //# fluent的使用方法 https://github.com/fastify/fluent-json-schema
...
//         // linebot.Notify('測試測試', '');
//         // const cpus = await os.getCpus();
//         // const test = await search('', 'gifs');

//         const result = 'test';
//         const data = command;
//         data.botType = 3;
//         data.responType = 1;
//         data.commandString = 'test';
//         data.content = ['this is test'];
//         data.createdTimestamp = '';
//         data.active = 1;
//         const keyName = 'command:' + data.commandString;
//         // await redis.set(keyName, data, 0);
//         await redis.hset(keyName, '1', data, 0);

//         reply.send({ result });
//     })

//     fastify.post('/lineTest', { schema }, async (request, reply) => {
//         const linebot = require('../../service/api/linebot');

//         const test = await linebot.messageGateWay(request);
